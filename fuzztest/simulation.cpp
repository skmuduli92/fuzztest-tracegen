...
int addr;
int one_byte_instruction[] = {  };

int two_byte_instruction[] = { 0x24, 0x25, 0x34, 0x35, 0x52, 0x54, 0x55, 0x82, 0xb0, 0xc2, 0xb2, 0x15, 0x05, 0x76,
			       0x77, 0xa6, 0xa7, 0x74, 0xe5, 0xa2, 0x78, 0x79, 0x7a, 0x7b, 0x7c, 0x7d, 0x7e, 0x7f,
			       0xa8, 0xa9, 0xaa, 0xab, 0xac, 0xad, 0xae, 0xaf, 0x92, 0x86, 0x87, 0x88, 0x89, 0x8a,
			       0x8b, 0x8c, 0x8d, 0x8e, 0x8f, 0xf5, 0x42, 0x44, 0x45, 0x72, 0xa0, 0xd0, 0xc0, 0x94,
			       0x95, 0xc5, 0x62, 0x64, 0x65 };
...
int  wait(unsigned long delay, Voc8051_tb *top,  std::ofstream& tracefile){
	...
	{
	  std::cout << "tracking FSM writer activity" << std::endl;
	  std::cout << "mem value : "
		    << std::dec << (int)top->oc8051_tb__DOT__oc8051_xiommu1__DOT__oc8051_xram_i__DOT__buff[FSM_WR_ADDR]
		    << std::endl;
...
void new_test(Voc8051_tb *top){
    ...
    std::cout << "no of buff: " << (int) num_buff << std::endl;
    ...
    std::cout << "LOG: ** updated fsm_writer data" << std::endl;
    return;
}
